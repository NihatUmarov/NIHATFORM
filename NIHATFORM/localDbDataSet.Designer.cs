...
namespace NIHATFORM {
    ...
    public partial class localDbDataSet : global::System.Data.DataSet {
        ...
        public partial class UserDataTable : global::System.Data.TypedTableBase<UserRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public UserRow AddUserRow(string first, string second, string age) {
        ...
        public partial class UserRow : global::System.Data.DataRow {
            ...
            public string first {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'first\' в таблице \'User\' равно DBNull.", e);
                    }
                }
                set {
            ...
            public string second {
                get {
                    try {
                        return ((string)(this[this.tableUser.secondColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'second\' в таблице \'User\' равно DBNull.", e);
                    }
                }
                set {
                    this[this.tableUser.secondColumn] = value;
                }
            }
            ...
            public bool IssecondNull() {
                return this.IsNull(this.tableUser.secondColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetsecondNull() {
                this[this.tableUser.secondColumn] = global::System.Convert.DBNull;
            }
...
namespace NIHATFORM.localDbDataSetTableAdapters {
    ...
    public partial class UserTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[User] WHERE (([Id] = @Original_Id) AND ((@IsNull_first = 1 AND [first] IS NULL) OR ([first] = @Original_first)) AND ((@IsNull_second = 1 AND [second] IS NULL) OR ([second] = @Original_second)) AND ((@IsNull_age = 1 AND [age] IS NULL) OR ([age] = @Original_age)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[User] ([first], [second], [age]) VALUES (@first, @second, @age" +
                ");\r\nSELECT Id, first, second, age FROM [User] WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[User] SET [first] = @first, [second] = @second, [age] = @age WHERE (([Id] = @Original_Id) AND ((@IsNull_first = 1 AND [first] IS NULL) OR ([first] = @Original_first)) AND ((@IsNull_second = 1 AND [second] IS NULL) OR ([second] = @Original_second)) AND ((@IsNull_age = 1 AND [age] IS NULL) OR ([age] = @Original_age)));
SELECT Id, first, second, age FROM [User] WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, first, second, age FROM dbo.[User]";
        ...
        public virtual int Delete(int Original_Id, string Original_first, string Original_second, string Original_age) {
            ...
            if ((Original_second == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[4].Value = ((string)(Original_second));
            }
        ...
        public virtual int Insert(string first, string second, string age) {
            if ((first == null)) {
        ...
        public virtual int Update(string first, string second, string age, int Original_Id, string Original_first, string Original_second, string Original_age, int Id) {
            if ((first == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string first, string second, string age, int Original_Id, string Original_first, string Original_second, string Original_age) {
            return this.Update(first, second, age, Original_Id, Original_first, Original_second, Original_age, Original_Id);
        }
    }
